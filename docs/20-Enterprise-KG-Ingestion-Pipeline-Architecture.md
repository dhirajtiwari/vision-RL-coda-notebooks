...
| **Semantic mapping** | Map fields → **existing TBox** concepts (“semantic lift” into ABox — not inventing a new ontology per product). See [`22-TBox-ABox-Multi-Source-Onboard-Mechanism.md`](22-TBox-ABox-Multi-Source-Onboard-Mechanism.md). Theory / sparse / scale: [`24-TBox-Sparse-Data-and-Enterprise-Scale-Patterns.md`](24-TBox-Sparse-Data-and-Enterprise-Scale-Patterns.md). |
